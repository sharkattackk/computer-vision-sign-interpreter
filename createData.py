...
#region of interest bounds in px
ROI_top = 50 #top bound
ROI_bottom = 300 #bottom bound
ROI_right = 150 #right bound
ROI_left = 350 #left bound
...
while True:
    ...
    #Time to configure the hand specifically into the ROI...
        ...
        cv2.putText(frame_copy, "Adjust hand...Gesture for" + element, (200, 400), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,255), 2)
        ...
        if hand is not None:
            ...
            if num_imgs_taken <= 40:
                ...
                os.chdir(r'C:\\gestures\\test\\j')
                cv2.imwrite(r''+str(num_imgs_taken) + '.jpg', thresholded)
                print("saved...")
            else:
                break
            num_imgs_taken +=1
